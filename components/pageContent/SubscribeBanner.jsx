  ...
  return (
    ...
    <section className="w-full bg-white dark:bg-[#070314] pt-16 px-6 md:px-10 lg:px-16 font-sans transition-colors duration-300">
      <div className="w-full mx-auto">
        ...
        {/* 🌌 মেইন কন্টেইনার (flex-row এবং justify-between যা দুই পাশের এলিমেন্টকে স্ক্রিনের দুই প্রান্তে ধাক্কা দিয়ে রাখবে) */}
        <div className="w-full bg-[#0b061f] dark:bg-[#090518] rounded-t-3xl rounded-b-none p-6 md:p-8 lg:p-10 shadow-xl flex flex-col lg:flex-row lg:items-center justify-between gap-8 relative overflow-hidden">
          ...
          {/* 📬 বাম পাশ: আইকন, টাইটেল, ডেসক্রিপশন */}
          <div className="flex flex-col sm:flex-row items-center sm:items-start lg:items-center gap-5 text-center sm:text-left relative z-10 max-w-xl">
            {/* মেইল আইকন র্যাপার */}
            <div className="w-16 h-16 bg-white/5 border border-white/10 rounded-full flex items-center justify-center text-purple-300 flex-shrink-0 shadow-inner">
          ...
          {/* ✉️ ডান পাশ: ফর্ম এবং বাটন এরিয়া */}
          {/* lg:w-[480px] দিয়ে সাইজ ফিক্সড করা হলো এবং flex-col দিয়ে নিচের টেক্সটের জায়গা আলাদা করা হলো */}
          <div className="w-full lg:w-[480px] flex flex-col gap-2 relative z-10 flex-shrink-0">
            <form onSubmit={handleSubmit} className="w-full flex flex-row items-center gap-3">

              {/* ইনপুট বক্স (কোনো ওপরে-নিচে ভাঙার সুযোগ নেই, কারণ প্যারেন্ট সরাসরি flex-row) */}
              ...
              {/* সাবস্ক্রাইব বাটন (ইনপুট বক্সের সাথে একদম সমান লাইনে লকড) */}
              <button
                type="submit"
                className="bg-gradient-to-r from-[#6344f5] to-[#8a3ffc] hover:from-[#5032e6] hover:to-[#7c32eb] text-white font-bold text-[15px] px-7 py-3.5 rounded-xl shadow-lg shadow-purple-600/20 active:scale-[0.98] transition-all duration-300 cursor-pointer text-center whitespace-nowrap"
              >
                Subscribe
              </button>
            </form>

            {/* 📝 নো-স্প্যাম টেক্সট: এটাকে ফর্মের বাইরে নিচে পাঠানো হলো, যেন এটি বাটনের অ্যালাইনমেন্ট নষ্ট না করে */}
